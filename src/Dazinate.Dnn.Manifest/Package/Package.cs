...
namespace Dazinate.Dnn.Manifest.Package
{
    ...
    public class Package : BusinessBase<Package>, IPackage
    {
        ...
        public static readonly PropertyInfo<DependenciesList> DependenciesListProperty = RegisterProperty<DependenciesList>(c => c.Dependencies);
        public IDependenciesList Dependencies
        {
            get { return GetProperty(DependenciesListProperty); }
            set { SetProperty(DependenciesListProperty, value); }
        }

        public static readonly PropertyInfo<ComponentsList> ComponentsListProperty = RegisterProperty<ComponentsList>(c => c.Components);
