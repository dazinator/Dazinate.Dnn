...
namespace Dazinate.Dnn.Manifest.Model.LanguageFile
{
    [ObjectFactory(typeof(ILanguageFileObjectFactory))]
    [Serializable]
    public class LanguageFile : BusinessBase<LanguageFile>, ILanguageFile
    {
